...
import (
	...
	"github.com/fringeproject/fringe-runner/modules/cloudflare"
	...
	"github.com/fringeproject/fringe-runner/modules/tor"
	...
	"github.com/fringeproject/fringe-runner/modules/webscreenshot"
...
func LoadModules(sess *session.Session) {
	...
	sess.RegisterModule(cloudflare.NewCloudflareDOH())
	...
	sess.RegisterModule(tor.NewTor())
	...
	sess.RegisterModule(webscreenshot.NewWebScreenshot())
	sess.RegisterModule(whoisxmlapi.NewWhoisXMLAPI())
